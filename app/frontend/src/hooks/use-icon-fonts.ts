...
// These CDN downloads only happen in Expo Go (StoreClient). EAS APK/IPA builds
// bundle all @expo/vector-icons fonts via autolinking — useFonts({}) resolves
// instantly in production so this map is never used.
